// Crie um programa que utilize o console.logpara exibir 
...
//  "Olá, [seu nome]!" nenhum console do navegador.

 let nome = 'Gui Lima';
console.log(`Olá, ${nome}!`);

// Crie uma variável chamada "nome" e atribua a ela o seu nome. 
// Em seguida, utilize o alertpara exibir a mensagem "Olá, [seu nome]!".

let nome = 'Gui Lima';
alert(`Olá, ${nome}!`);

// Utilize o prompte faça a seguinte pergunta:
//  Qual  a linguagem de programação que você mais gosta?. Em seguida, armazene
//  a resposta em uma variável e mostre no console do navegador.

 let linguagemPreferida = prompt('Qual  a linguagem de programação que você mais gosta?');
console.log(linguagemPreferida);

// Crie uma variável chamada "valor1" e outra chamada "valor2",
//  atribuindo a eles valores numéricos de sua escolha. 
//  Em seguida, realize a soma desses dois valores e armazene 
//  o resultado em uma terceira variável chamada "resultado".
...
//   exibindo uma mensagem correspondente no console.
...
// Crie uma variável "numero" e peça um valor com promptverifique
//  se é positivo, negativo ou zero. Use if-else para imprimir
...
//   Use o Math.ramdonpara gerar qualquer número 
//   aleatório e exiba esse número no console.

let numeroAleatorio = Math.random();
console.log(numeroAleatorio);

// Use o Math.ramdonpara gerar um número 
...
// Use o Math.ramdonpara gerar um número inteiro entre
